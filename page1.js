...
__SYD.page1 = () =>{
    return __c(
        "div",
        {
            style:"min-height:100vh;height:fit-content;width:100%;display:flex;justify-content:center;align-items:center;flex-direction:column;row-gap:30px;padding:0 10px;background-image:url('./assets/front_.png');padding-top:90px;"
        },
        [
            __c(
                "div",
                ...
                [
                    __c(
                        "h1",
                        {style:"text-align:center;font-family:shine;text-shadow:2px 2px 1px #141414;position:relative;"},
                        [
