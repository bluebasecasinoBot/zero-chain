...
__SYD.scaleNav = () =>{
    ...
    return __c(
        "div",
        {
            style:`position:fixed;top:0px;bottom:auto;left:0;width:100%;padding:${check ? "20px 30px" : "20px 10px"};display:flex;align-items:center;column-gap:50px;justify-content:space-between;user-select:none;z-index:500;background:${"rgb(20, 144, 206)"};color:${"#ffc2cb"};font-weight:900;transition:unset;box-shadow:0px 2px 3px #000;transform:translateY(-1px);transition:all linear .3s;`//background:linear-gradient(#000,#0000);
        },
        [   
